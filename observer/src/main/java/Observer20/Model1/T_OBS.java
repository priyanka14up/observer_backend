...
public class T_OBS {
	...
	public T_OBS(String eCI_OBSID, String iD_NO, String oB_TITLE, String oB_NAME, String oB_SERVICE, String oB_CADRE,
			String oB_YEAR, String oB_SEX, String oB_DOB, String oB_STATUS, String oB_LANG, String oB_DESIG,
			String o_ADR_L1, String o_CITY, String o_STATE, String o_PIN, String o_STD, String o_TEL_DRCT,
			String o_TEL_PBX, String o_TEL_EXT, String o_FAX, String o_EMAIL, String o_MOBILE, String r_PIN,
			String r_STD, String r_TNO, String r_FAX, String eMG_NAME, String oB_HM_STAT, String sP_HM_STAT,
			String sPONSOR, String sPON_OBSID, String oB_TYPE, String dELHIBASED, String sPLOBSERVER,
	...
	public String toString() {
		return "T_OBS [ECI_OBSID=" + ECI_OBSID + ", ID_NO=" + ID_NO + ", OB_TITLE=" + OB_TITLE + ", OB_NAME=" + OB_NAME
				+ ", OB_SERVICE=" + OB_SERVICE + ", OB_CADRE=" + OB_CADRE + ", OB_YEAR=" + OB_YEAR + ", OB_SEX="
				...
				+ O_PIN + ", O_STD=" + O_STD + ", O_TEL_DRCT=" + O_TEL_DRCT + ", O_TEL_PBX=" + O_TEL_PBX
				+ ", O_TEL_EXT=" + O_TEL_EXT + ", O_FAX=" + O_FAX + ", O_EMAIL=" + O_EMAIL + ", O_MOBILE=" + O_MOBILE
				+ ", R_PIN=" + R_PIN + ", R_STD=" + R_STD + ", R_TNO=" + R_TNO + ", R_FAX=" + R_FAX + ", EMG_NAME="
				+ EMG_NAME + ", OB_HM_STAT=" + OB_HM_STAT + ", SP_HM_STAT=" + SP_HM_STAT + ", SPONSOR=" + SPONSOR
				+ ", SPON_OBSID=" + SPON_OBSID + ", OB_TYPE=" + OB_TYPE + ", DELHIBASED=" + DELHIBASED
