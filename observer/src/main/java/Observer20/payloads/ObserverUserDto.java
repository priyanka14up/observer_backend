...
public class ObserverUserDto {
	...
	public String toString() {
		return "ObserverUserDto [id=" + id + ", obscode=" + obscode + ", name=" + name + ", email=" + email
				...
				+ EMG_TEL + ", OB_REQ_STATUS=" + OB_REQ_STATUS + ", OB_image=" + OB_image + "]";
	}
	public ObserverUserDto(int id, @NotEmpty String obscode,
			...
			@NotEmpty String role, @NotEmpty String service, @NotNull long mobnum, @NotNull int workexperience,
			...
			String oB_CDEP, String exp_as_RO, String exp_as_DEO, String exp_as_OtherElectionDuty, String o_TEL_DRCT,
			String o_TEL_PBX, String o_TEL_EXT, String eMG_TEL, String oB_REQ_STATUS, String oB_image) {
		super();
		this.id = id;
		this.obscode = obscode;
		this.name = name;
